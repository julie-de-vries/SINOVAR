...
public class Professionnel {
    ...
    public Professionnel(String id, String motDePasse, String nom, String prenom, Metier metier, String departement, String tel, String mail) {
        this.id_pro = id;
        this.nom = nom;
        this.prenom = prenom;
